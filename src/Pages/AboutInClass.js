...
function AboutInClass(){
    return (
        <div>
            <h1>Sobre o IEEE InClass</h1>
            <article>
                ...
                <p>Envolvendo engenheiros de computação, cientistas, acadêmicos e profissionais da indústria de todas as áreas da computação, a IEEE Computer Society (CS) 
                    ...
                    engenharia em todas as fases de suas carreiras para diálogo, debate e colaboração, 
                    o IEEE CS capacita, molda e orienta o futuro não apenas de seus membros, mas também da grande indústria, 
                    permitindo novas oportunidades para servir melhor o nosso mundo.</p>
            </article>
        </div>
    );
}
